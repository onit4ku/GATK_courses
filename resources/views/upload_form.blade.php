    ...
    <div class="form-style-10" id="large-header" class="large-header">
        <form action="/upload" id="GATKForm" data-toggle="validator" role="form" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group has-feedback">
                ...
                <textarea rows="4" cols="50" maxlength="190" class="form-control" id="interestsId" name="researchInterests" aria-describedby="researchInterests"placeholder="Tell us about your interests briefly." 
            ...
            <div class="form-group has-feedback">
                ...
                <input type="text" maxlength="190" class="form-control" id="institution" name="institution" aria-describedby="institution" placeholder="Enter your group name."
            ...
            <div class="form-group has-feedback">
                ...
                <input type="text" maxlength="190" class="form-control" id="position" name="position" aria-describedby="position" placeholder="Enter your position."
            ...
            <div class="form-group has-feedback">
                ...
                <input type="text" maxlength="190" class="form-control" id="fullName" name="fullName" aria-describedby="inputInstitution" placeholder="Enter your full name."
            ...
            <div class="form-group has-feedback">
                ...
                <input type="email"  maxlength="190" class="form-control" id="email" placeholder="Enter your email address." name="email" data-error="That email address is invalid."
                    required>
                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                <div class="help-block with-errors"></div>
            </div>
